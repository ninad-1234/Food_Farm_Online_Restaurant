...
$dish=$row["fav_dish"];
$cnt=0;
$result2=mysqli_query($conn,"SELECT DISTINCT dish from basket where username='$username'");
...
<!-- For Navbar -->
    ...
    <div class = "navbar">
<a href = "before_login_home.php">Logout</a>
  <a href = "#contact">Contact</a>

  <a href = "team.html">Team</a>

  <a href="view_basket.php">View Cart<sub style="margin-left:5px;padding:1px;background-color:green;"> <?php echo $cnt ; ?>  </sub></a>

  <a href = "menue.html">Menu Card</a>
...
<br><br><br><h1 align="center" style="padding-top:10px;">Welcome <?php  echo $f_name;  ?></h1><br>
...
<img src="data:image/jpeg;base64,<?php echo base64_encode( $row1['img1'] ); ?>"style="width:1000px; height: 500px;">
 
<form action="add_basket.php" method="post">
<?php $no=101; ?>
  <button class="btn" onclick="bowl('<?php echo $row1['dish_name'];   ?>',<?php echo $no ?>)">Order Now</button>
  <input type="hidden" name="dish" id="dish<?php echo $no; ?>" />
</form>

</div>

<div class="mySlides fade">
<img src="data:image/jpeg;base64,<?php echo base64_encode( $row1['img2'] ); ?>"style="width:1000px; height: 500px;">
...
<div class="mySlides fade">
<img src="data:image/jpeg;base64,<?php echo base64_encode( $row1['img3'] ); ?>"style="width:1000px; height: 500px;">
  <button class="btn">Order Now</button>
</div>

<div class="mySlides fade">
<img src="data:image/jpeg;base64,<?php echo base64_encode( $row1['img4'] ); ?>"style="width:1000px; height: 500px;">
  <button class="btn">Order Now</button>
</div>

<div class="mySlides fade">
<img src="data:image/jpeg;base64,<?php echo base64_encode( $row1['img5'] ); ?>"style="width:1000px; height: 500px;">
...
function bowl(dish,no)
{
  alert(dish+"  added to ypur cart");
  ...
  <tr>
    ...
    <form action="add_basket.php" method="post">
      <td class="zoom" style="text-align: center;"><img src="food_pics/vada-pav.jpg" alt="" style="width: 450px; height: 250px;">
        ...
        <br>&#8377;150<br>
        <?php $no=0; ?>
        <button type="submit" class="dish"  value="Submit" style="background: green; color: white; width: 500px; height: 30px; font-size: 15px;"onclick="bowl('vadapav',<?php echo $no ?>)" >Add to Bowl</button></td><td></td><td></td><td></td><td></td>
        <input type="hidden" name="dish" id="dish<?php echo $no; ?>" />
</form>
...
<form action="add_basket.php" method="post">
        ...
        <br>&#8377;120<br>
        <?php $no=$no+1; ?>
        <button type="submit" class="dish" value="Submit" style="background: green; color: white; width: 500px; height: 30px; font-size: 15px;" onclick="bowl('South Indian Lemon Rice',<?php echo $no ?>)" >Add to Bowl</td><td></td><td></td><td></td><td></td>
        <input type="hidden" name="dish" id="dish<?php echo $no; ?>" />
      </form>
      <form action="add_basket.php" method="post">
        ...
        <br>&#8377;125<br>
        <?php $no=$no+1; ?>
        <button type="submit" class="dish" value="Submit" style="background: green; color: white; width: 500px; height: 30px; font-size: 15px;" onclick="bowl('Lentil Dal',<?php echo $no ?>)" >Add to Bowl</td><td></td><td></td><td></td><td></td>
        <input type="hidden" name="dish" id="dish<?php echo $no; ?>" />
      </form>
    </tr> 
    <tr>
